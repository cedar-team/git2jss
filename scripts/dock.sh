...
Apps=("Google Chrome.app" "Slack.app" "PyCharm.app" "iTerm.app" "System Preferences.app" "Microsoft Word.app" "Microsoft Excel.app" "Microsoft PowerPoint.app" "App store.app")
